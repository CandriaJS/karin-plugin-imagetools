...
import { help as Help } from '@/models'
import { Version } from '@/root'
import type { HelpType } from '@/types'

export const help = karin.command(/^#?(?:(?:柠糖)(?:图片操作|imagetools))(?:命令|帮助|菜单|help|说明|功能|指令|使用说明)$/i, async (e: Message) => {
...
export const version = karin.command(/^#?(?:(?:柠糖)(?:图片操作|imagetools))(?:版本|版本信息|version|versioninfo)$/i, async (e: Message) => {
